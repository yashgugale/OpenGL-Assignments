package com.yashg.smiley_texture_tweaked;						// For tweaked smiley texture
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private int tapSelection = 0;		// Tweaking the smiley on key press
	...
	{
		tapSelection = (tapSelection + 1) % 4;		// change the selection on tapping
		return(true);
	}
	...
	public void display()
	{
		...
		if(tapSelection == 0)
		{
			smileyTexcoords[0] = 0.5f; smileyTexcoords[1] = 0.5f;
			smileyTexcoords[2] = 0.0f; smileyTexcoords[3] = 0.5f;
			smileyTexcoords[4] = 0.0f; smileyTexcoords[5] = 0.0f;
			smileyTexcoords[6] = 0.5f; smileyTexcoords[7] = 0.0f;
		}
		else if (tapSelection == 1)
		{
			smileyTexcoords[0] = 1.0f; smileyTexcoords[1] = 1.0f;
			smileyTexcoords[2] = 0.0f; smileyTexcoords[3] = 1.0f;
			smileyTexcoords[4] = 0.0f; smileyTexcoords[5] = 0.0f;
			smileyTexcoords[6] = 1.0f; smileyTexcoords[7] = 0.0f;
		}
		else if (tapSelection == 2)
		{
			smileyTexcoords[0] = 2.0f; smileyTexcoords[1] = 2.0f;
			smileyTexcoords[2] = 0.0f; smileyTexcoords[3] = 2.0f;
			smileyTexcoords[4] = 0.0f; smileyTexcoords[5] = 0.0f;
			smileyTexcoords[6] = 2.0f; smileyTexcoords[7] = 0.0f;
		}
		else if (tapSelection == 3)
		{
			smileyTexcoords[0] = 0.5f; smileyTexcoords[1] = 0.5f;
			smileyTexcoords[2] = 0.5f; smileyTexcoords[3] = 0.5f;
			smileyTexcoords[4] = 0.5f; smileyTexcoords[5] = 0.5f;
			smileyTexcoords[6] = 0.5f; smileyTexcoords[7] = 0.5f;
		}
		
		// DYNAMIC BUFFER BLOCK FOR TEXTURE:
		GLES32.glGenBuffers(1, vboSmileyTexture, 0);							// Generate buffer object names (here, for texture);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboSmileyTexture[0]);		// Bind a named buffer object to the specified binding point
