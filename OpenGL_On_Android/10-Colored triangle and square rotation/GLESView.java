package com.yashg.colored_triangle_square_rotation;				// For Perspective Colored triangle and square rotation
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		// We will disable culling of back faces as we are performing rotation:
	...
	public void display()
	{
		...
		Matrix.rotateM(RotationMatrix, 0, RotationMatrix, 0, angleTri, 0.0f, 1.0f, 0.0f);	// Rotate triangle about the y axis
		...
		// Rotate the Rotation Matrix
		Matrix.rotateM(RotationMatrix, 0, RotationMatrix, 0, angleSquare, 1.0f, 0.0f, 0.0f);	// Rotate square about the x axis
