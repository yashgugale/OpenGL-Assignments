package com.yashg.two_white_shapes;								// For Perspective triangle and square
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		GLES32.glGenBuffers(1, vboTriangle, 0);							// Generate buffer object names;
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboTriangle[0]);	// Bind a named buffer object to the specified binding point
		...
		ByteBuffer TriangleByteBuffer = ByteBuffer.allocateDirect(triangleVertices.length * 4);
		...
		GLES32.glGenBuffers(1, vboSquare, 0);						// Generate buffer object names;
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboSquare[0]);	// Bind a named buffer object to the specified binding point
