package com.yashg.gles_view;		// Different package ID for a new program
...
{
	private GLESView glesView;	// Can also be local. But in OpenGL we need it in scope of class
	...
	{	
		...
		*/
		...
		glesView = new GLESView(this);		// Create an object
		setContentView(glesView);			// Set the content as the new gles view
