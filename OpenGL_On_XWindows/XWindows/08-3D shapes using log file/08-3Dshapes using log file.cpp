...
int main(void)		
{
	...
	//Open file for writing the logs:
	...
	while(bDone == false)
	{
		...
		display();
		fprintf(gpFile,"Below display():\n\n");
		update();
		fprintf(gpFile,"Below Update():\n\n");
		//Spin call here
	}
	uninitialize();
	return(0);
...
void display(void)
{
	...
	fprintf(gpFile,"Below Multicolored_pyramid():\n\n");
	...
	multicolored_cube();
	fprintf(gpFile,"Below Multicolored_cube():\n\n");
