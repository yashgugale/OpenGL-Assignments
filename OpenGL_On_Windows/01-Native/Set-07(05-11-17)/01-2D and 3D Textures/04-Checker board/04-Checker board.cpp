...
void initialize(void)
{
	...
	glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);	//Nicest is used to avoid aliasing if geomerty having texture mapped to it changes orientation.
