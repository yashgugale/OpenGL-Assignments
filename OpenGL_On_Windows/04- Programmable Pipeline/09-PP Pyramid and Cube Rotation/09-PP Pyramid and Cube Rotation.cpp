...
void initialize(void)
{
	...
	*/
	...
	glGenBuffers(1, &gVboPyramidColor);					// Buffer to store vertex colors
	glBindBuffer(GL_ARRAY_BUFFER, gVboPyramidColor);		// Find that named object in memory
	...
	// B. BUFFER BLOCK FOR COLORS:
	glGenBuffers(1, &gVboCubeColor);					// Buffer to store vertex colors
	glBindBuffer(GL_ARRAY_BUFFER, gVboCubeColor);		// Find that named object in memory
