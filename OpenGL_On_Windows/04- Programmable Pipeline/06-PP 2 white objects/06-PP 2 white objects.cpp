...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("OpenGL Programmable Pipeline : 2 white objects"),
...
void initialize(void)
{
	...
	*/
	...
	glGenBuffers(1, &gVboTriangle);					// Buffer to store vertex position
	glBindBuffer(GL_ARRAY_BUFFER, gVboTriangle);	// Find that named object in memory
	...
	glGenBuffers(1, &gVboSquare);					// Buffer to store vertex positions
	glBindBuffer(GL_ARRAY_BUFFER, gVboSquare);		// Find that named object in memory
